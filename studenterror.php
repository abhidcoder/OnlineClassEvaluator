...
if(isset($_POST['submit'])){
    ...
    $inserting="INSERT INTO insertion(col1,col2) VALUES('$uname','$password')";
...
<body>  
    ...
    <h4 style="text-align:center;"><p style="color:red">Please enter valid details!</p></h4>
     ...
     <div class="col-lg-6">
      <form action ="studenterror.php" method="post">
   ...
   <div class="form-group">
    ...
    <label for="department">YEAR</label> 
        <select name="year" id="department" class="form-control">
        <option>FIRST</option>
